...
class _RegisterScreenState extends State<RegisterScreen>
  ...
  Future<void> _handleGoogleSignIn(BuildContext context) async {
    ...
    final curState = authBloc.state;
    if (curState is! Authenticated && curState is! AuthLoading) {
      _showGoogleEmailModal(context);
    }
  }

  void _showGoogleEmailModal(BuildContext context) {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Image.asset('assets/icons/google.png', width: 24, height: 24, errorBuilder: (_, __, ___) => const Icon(Icons.g_mobiledata, size: 28)),
                    const SizedBox(width: 12),
                    Text(
                      'Google Quick Sign-In',
                      style: GoogleFonts.inter(fontSize: 18, fontWeight: FontWeight.bold, color: auraTheme.textPrimary),
                    ),
                  ],
                ),
                ...
                Text(
                  ...
                  style: GoogleFonts.inter(fontSize: 13, color: auraTheme.textSecondary),
                ),
                const SizedBox(height: 16),
                TextField(
                  controller: nameCtrl,
                  textCapitalization: TextCapitalization.words,
                  style: GoogleFonts.inter(color: auraTheme.textPrimary, fontSize: 14),
                  decoration: InputDecoration(
                ...
                TextField(
                  ...
                  style: GoogleFonts.inter(color: auraTheme.textPrimary, fontSize: 14),
                  decoration: InputDecoration(
                    hintText: 'Email (e.g. ahmed@gmail.com)',
                    hintStyle: GoogleFonts.inter(color: auraTheme.textMuted, fontSize: 14),
                    filled: true,
                    fillColor: auraTheme.card,
                    border: OutlineInputBorder(
                    ...
                    onPressed: () {
                      ...
                      if (inputEmail.isNotEmpty && inputEmail.contains('@')) {
                        ...
                        context.read<AuthBloc>().add(GoogleSignInSubmitted(
                          overrideEmail: inputEmail,
                          overrideName: inputName.isNotEmpty ? inputName : null,
                        ));
                      }
                    },
                    child: Text('Continue to Aura', style: GoogleFonts.inter(fontWeight: FontWeight.bold, fontSize: 15)),
                  ),
                ),
              ],
            ),
